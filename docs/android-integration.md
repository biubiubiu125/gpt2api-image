...
```json
{
  ...
  "data": [
    ...
    { "id": "codex-gpt-image-2", "object": "model", "owned_by": "gpt2api-image" },
    { "id": "auto", "object": "model", "owned_by": "gpt2api-image" },
    { "id": "gpt-5", "object": "model", "owned_by": "gpt2api-image" },
    { "id": "gpt-5-mini", "object": "model", "owned_by": "gpt2api-image" }
  ]
}
```
