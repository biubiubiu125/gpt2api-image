...
const ALL_QUOTA_KINDS: QuotaMeta[] = IMAGE_QUOTA_KINDS;
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-stone-500">
                  画图支持日限额、月限额、总额度三档；任一档可独立勾选「不限额」。
                </p>
              </div>
            </div>
