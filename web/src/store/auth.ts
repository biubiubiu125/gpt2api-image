...
export const AUTH_KEY_STORAGE_KEY = "gpt2api-image_auth_key";
export const AUTH_SESSION_STORAGE_KEY = "gpt2api-image_auth_session";
...
export function getDefaultRouteForRole(_role: AuthRole) {
  // admin / user 登录后默认都进生图页；这里是单一真相源，
